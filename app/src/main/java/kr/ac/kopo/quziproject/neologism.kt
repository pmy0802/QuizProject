...
class neologism : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_neologism)

        // 질문 리스트 가져오기
        questionList = QuestionData6.getQuestion()
            ...
            if (selectedOption != 0) {
                ...
                when {
                    ...
                    currentPosition <= questionList.size -> {
                        ...
                        // 결과 액티비티로 넘어가는 코드
                        val intent = Intent(this@neologism, ResultActivity::class.java)
